    ...
    <div v-if="loadedTheme" class="container mt-3">
        ...
        <div v-if="enableEditMode" class="sidebar" data-testid="edit-sidebar">
            <div class="sidebar-body">
                <div class="my-3">
                    ...
                    <div class="input-group">
                        <span
                            id="basic-addon3"
                            class="input-group-text rounded-start rounded-0"
                            >/status/</span
                        >
                        <input
                            id="slug"
                            v-model="config.slug"
                            type="text"
                            class="form-control rounded-end rounded-0"
                        />
                    </div>
                </div>
            ...
            <div class="sidebar-footer">
                <button
                    class="btn btn-success glass-button me-2"
                    :disabled="loading"
                ...
                <button
                    class="btn btn-danger glass-button-danger me-2"
                    @click="discard"
                >
...
.overall-status {
    ...
    &:hover {
        ...
        &::before {
            background-color: rgba(92, 221, 139, 0.8);
        }

        .ok {
            color: rgba(92, 221, 139, 1);
            transform: scale(1.1);
        }

        .warning {
            color: rgba(248, 163, 6, 1);
            transform: scale(1.1);
        }
...
.sidebar {
    ...
    .sidebar-footer {
        ...
        left: 0;
        bottom: 0;
        background-color: $glass-bg-light;
...
.dark {
    .sidebar {
        ...
        .sidebar-footer {
            border-right-color: $glass-border-dark;
            border-top-color: $glass-border-dark;
            background-color: $glass-bg-dark;
            backdrop-filter: blur($glass-blur);
            -webkit-backdrop-filter: blur($glass-blur);
            box-shadow: $glass-shadow;
        }
...
/* 毛玻璃按钮样式 */
.glass-button {
    background: rgba(255, 255, 255, 0.2) !important; /* 半透明绿色背景 */
    ...
    &:hover:not(:disabled) {
        background: rgba(255, 255, 255, 0.2) !important; /* 悬停时加深背景色 */
...
/* 危险按钮毛玻璃样式 */
.glass-button-danger {
    background: rgba(92, 221, 139, 0.8) !important; /* 半透明绿色背景 */
    backdrop-filter: blur($glass-blur); /* 背景模糊效果 */
    -webkit-backdrop-filter: blur($glass-blur); /* Safari浏览器兼容 */
    border: 1px solid rgba(255, 255, 255, 0.2) !important; /* 半透明边框 */
    box-shadow: $glass-shadow; /* 轻微阴影效果 */
    ...
    &:hover {
        background: rgba(92, 221, 139, 0.9) !important; /* 悬停时加深背景色 */
        transform: translateY(-2px); /* 轻微上浮效果 */
    }
