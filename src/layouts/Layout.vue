<template>
    <div :class="classes">
        ...
        <header
            v-if="!$root.isMobile"
            class="d-flex flex-wrap justify-content-center py-3 mb-3 glassmorphism-header"
        >
            <router-link
                to="/dashboard"
        ...
        <header
            v-else
            class="d-flex flex-wrap justify-content-center pt-2 pb-2 mb-3 glassmorphism-header-mobile"
        >
            <router-link
                to="/dashboard"
...
.glassmorphism-header {
    ...
    border-bottom: 1px solid rgba(255, 255, 255, 0.3) !important; /* 半透明边框 */
...
.title,
.nav-link {
    color: rgba(0, 0, 0, 0.8) !important; /* 深色文字 */
...
.dark {
    .title,
    .nav-link {
        color: rgba(255, 255, 255, 0.9) !important; /* 暗色模式下的浅色文字 */
    }
    ...
    header {
        background: rgba(
            ...
            0,
            0.2
        ) !important; /* 暗色模式下的半透明黑色背景 */
        border-bottom: 1px solid rgba(255, 255, 255, 0.1) !important; /* 暗色模式下的边框 */
    }
}
...
.bottom-nav {
    ...
    backdrop-filter: blur(10px); /* 背景模糊效果 */
    -webkit-backdrop-filter: blur(10px); /* Safari浏览器兼容 */
    border-top: 1px solid rgba(255, 255, 255, 0.3) !important; /* 半透明顶部边框 */
}
...
.dark {
    .bottom-nav {
        ...
        border-top: 1px solid rgba(255, 255, 255, 0.1) !important; /* 暗色模式下的顶部边框 */
    }
}
